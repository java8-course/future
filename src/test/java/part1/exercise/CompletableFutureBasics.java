...
public class CompletableFutureBasics {
    ...
    public void flatMap() throws ExecutionException, InterruptedException {
        ...
        final Optional<Integer> optFirstCodePointOfFirstName = Stream.of(person)
                .flatMapToInt(p -> p.getFirstName().codePoints())
                .mapToObj(Integer::valueOf)
                .findFirst();

        assertEquals(Integer.valueOf(65), optFirstCodePointOfFirstName.get()); // A - 65
        ...
        final CompletableFuture<Employee> futureEmployee =
                futurePerson.thenCompose(p -> employeeDb.get(getKeyByPerson(p)));
