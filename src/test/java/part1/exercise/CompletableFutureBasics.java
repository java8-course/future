...
public class CompletableFutureBasics {
    ...
    public void createEmpty() throws ExecutionException, InterruptedException {
        ...
        assertTrue(futurePerson.thenApply(x -> false).exceptionally(t -> t.getCause() instanceof NoSuchElementException).get());
    }
    ...
    public void flatMap() throws ExecutionException, InterruptedException {
        ...
        final Optional<Integer> optFirstCodePointOfFirstName = optPerson.flatMap(p -> p
                .getFirstName()
                .codePoints()
                .boxed()
                .findFirst());
