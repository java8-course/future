...
public class CompletableFutureBasics {
    ...
    public void map() throws ExecutionException, InterruptedException {
        ...
        final Optional<String> optFirstName = Optional.of(optPerson.get().getFirstName());
        ...
        final Stream<String> streamFirstName = streamPerson.map(a->a.getFirstName());
        ...
        final CompletableFuture<String> futureFirstName =
                futurePerson.thenApply(a->a.getFirstName());
    ...
    public void flatMap() throws ExecutionException, InterruptedException {
        ...
        final Optional<Integer> optFirstCodePointOfFirstName =
                optPerson.flatMap(per -> per.getFirstName().codePoints().mapToObj(p -> p).findFirst());;
        ...
        final IntStream codePoints =
                streamPerson.flatMapToInt(a->a.getFirstName().codePoints());
        ...
        final CompletableFuture<Employee> futureEmployee =
                futurePerson.thenApply(a -> getKeyByPerson(a))
                        .thenCompose(a->employeeDb.get(a));
