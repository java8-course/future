...
public class CompletableFutureBasics {
    ...
    public void flatMap() throws ExecutionException, InterruptedException {
        ...
        final Optional<Integer> optFirstCodePointOfFirstName = optPerson.flatMap(e -> e.getFirstName().
                codePoints().mapToObj(p -> p).findFirst());
        ...
        final IntStream codePoints = streamPerson.flatMapToInt(e -> e.getFirstName().codePoints());
        ...
        final CompletableFuture<Employee> futureEmployee = futurePerson.thenCompose(e -> employeeDb.get(getKeyByPerson(e)));
