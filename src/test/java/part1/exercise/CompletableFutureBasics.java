...
public class CompletableFutureBasics {
    ...
    public void map() throws ExecutionException, InterruptedException {
        ...
        final CompletableFuture<String> futureFirstName = futurePerson.thenApplyAsync(Person::getFirstName);
    ...
    public void flatMap() throws ExecutionException, InterruptedException {
        ...
        final Optional<Integer> optFirstCodePointOfFirstName =
                optPerson.flatMap(f -> f.getFirstName().codePoints().mapToObj(p -> p).findFirst());
        ...
        final IntStream codePoints = streamPerson.flatMapToInt(f -> f.getFirstName().codePoints());
        ...
        final CompletableFuture<Employee> futureEmployee = futurePerson.thenCompose(s -> employeeDb.get(getKeyByPerson(person)));
